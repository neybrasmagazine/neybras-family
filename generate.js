...
function footer(fromArticlesDir) {
  ...
  const footerCatLinks = data.tags.map(t => `
          <li><a href="${prefix}categorie-${t.slug}.html" class="nf-ft-link">${t.name}</a></li>`).join('');
  const footerTools = [TOOL_VACANCES, ...TOOLS];
  const footerToolLinks = footerTools.map(t => `
          <li><a href="${prefix}${t.href}" class="nf-ft-link">${t.navLabel}</a></li>`).join('');
  return `
            <footer class="nf-ft">
              <div class="container">
                <div class="nf-ft-main">
                  <div class="nf-ft-brand">
                    <a href="${prefix}index.html" class="nf-ft-logo">
                      <img src="${prefix}images/favicon.png" alt="Neybras Family" width="36" height="36" style="border-radius:6px;">
                      <span class="nf-ft-name">Neybras Family</span>
                    </a>
                    <p class="nf-ft-tagline">Argent, éducation, droit et vie de famille au Maroc — sans bruit.</p>
                    <div class="nf-ft-social">
                  ...
                  <div class="nf-ft-col">
                    <h5>Neybras Média Group</h5>
                    <ul>
          <li><a href="${prefix}a-propos.html" class="nf-ft-link">À propos</a></li>
          <li><a href="https://neybras-magazine.com/" target="_blank" rel="noopener" class="nf-ft-link">Neybras Magazine</a></li>
          <li><a href="https://neybras.com/" target="_blank" rel="noopener" class="nf-ft-link">Neybras Conseil</a></li>
                    </ul>
                  </div>
                </div>
                <div class="nf-ft-bottom">
                  <span>&copy; ${new Date().getFullYear()} Neybras Publishing SARLAU · Tous droits réservés</span>
                  <a href="${prefix}mentions-legales.html" class="nf-ft-link">Mentions légales</a>
                </div>
              </div>
            </footer>
        </div>
        ...
        (function(){
          ...
          form.addEventListener('submit', function(e){
            ...
            btn.disabled = true;
            fetch('https://formspree.io/f/xbdnjkdz', {
              method: 'POST',
